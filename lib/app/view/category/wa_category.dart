  ...
  Future<void> getCategory() async {
   ...
   setState(() {
     ...
     for(Map<String, dynamic> cate in wmc.category){
       categories.add(Category(cat_id: cate['cat_id'], photo_cat: cate['photo_cat'], name: cate['name'], status: cate['status'], color: cate['color']));
     }
   });
    loading = false;
  }
            ...
            child: ListView.builder(
                ...
                itemBuilder: (ctx, index){
                  return GestureDetector(
                    onTap: (){
                      pushPage(context, WaAllStickerByCat(id: categories[index].cat_id,));
                    },
                    child: Padding(
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: categories[index].color == "" ? getColorFromHex(GlobalColors().colorWhite) :
                                getColorFromHex(categories[index].color),
                                boxShadow: [
                                  BoxShadow(
                                    color: categories[index].color == "" ? getColorFromHex(GlobalColors().colorWhite) :
                                    getColorFromHex(categories[index].color),
